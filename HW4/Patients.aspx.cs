...
public partial class Patients : System.Web.UI.Page
{
    ...
    {
        cmd.CommandText = "DELETE FROM Patients WHERE PatientID = '" + txtDelID.Text +"'";
    ...
    private void BuildUpdatePatientCommand(IDbCommand cmd)
    {
        ...
        cmd.CommandText = "UPDATE Patients SET LastName = '" + txtUpdLName.Text + "'" + "WHERE PatientID = '" + txtUpdID.Text + "'";
        cmd.CommandText += "UPDATE Patients SET FirstName = '" + txtUpdFName.Text + "'" + "WHERE PatientID = '" + txtUpdID.Text + "'";
        cmd.CommandText += "UPDATE Patients SET Address = '" + txtUpdAddress.Text + "'" + "WHERE PatientID = '" + txtUpdID.Text + "'";
